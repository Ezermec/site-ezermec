...
export function HeroSearch() {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', background: '#fff', border: '1.5px solid var(--border)', borderRadius: 14, padding: 5, margin: '28px 0 0', maxWidth: 520, boxShadow: '0 10px 30px -18px rgba(5,40,87,.3)' }}>
